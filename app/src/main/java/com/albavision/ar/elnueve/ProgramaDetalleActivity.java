...
public class ProgramaDetalleActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener  {


    private ImageView imgPrograma;

    private LinearLayout llmasNoticias,llmasRepeticiones;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new DownloadImageFromInternet( imgPrograma)
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try{
                            ...
                            noticia_adapter = new main_noticia_adapter ( ProgramaDetalleActivity.this,noticiaLista);
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try{
                            ...
                            repeticiones_adapter = new programa_repeticiones_adapter ( ProgramaDetalleActivity.this,repeticionesLista);
        ...
        recycler_view_NOTICIAS_PRINCIPALES.addOnItemTouchListener(new RecyclerItemClickListener(this, new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                Intent intent = new Intent(ProgramaDetalleActivity.this, DetalleNoticiaActivity.class);
        ...
        recycler_view_REPETICIONES.addOnItemTouchListener(new RecyclerItemClickListener(this, new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                if(repeticionesLista.get(position).getVod_mp4().equals(""))
                {
                    ...
                    Intent intent = new Intent(ProgramaDetalleActivity.this, DetalleRepeticionActivity.class);
        ...
        llmasRepeticiones.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ProgramaDetalleActivity.this, MasRepeticionesActivity.class);
        ...
        llmasNoticias.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ProgramaDetalleActivity.this, MasNoticiasActivity.class);
                intent.putExtra("id", "1");
...
*/
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_inicio) {
            Intent intent = new Intent(ProgramaDetalleActivity.this, MainActivity.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(intent);
        } else if (id == R.id.nav_Combate) {
            Intent intent = new Intent(ProgramaDetalleActivity.this, ProgramaDetalleActivity.class);
            ...
            Intent intent = new Intent(ProgramaDetalleActivity.this, ProgramasActivity.class);
            intent.putExtra("from", "inicio");
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(intent);
        } else if (id == R.id.nav_noticias) {
            Intent intent = new Intent(ProgramaDetalleActivity.this, ResultadoActivity.class);
            intent.putExtra("id", "1");
            intent.putExtra("titulo", "Noticias");
